...
var (
	...
	ErrAdminCommandNotAllowed      = errors.New("role and privilege administration is not permitted through the proxy")
	ErrRestrictedCommandNotAllowed = errors.New("blocked: this operation is not permitted through the proxy")
